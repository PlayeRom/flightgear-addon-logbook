...
DefaultStyle.widgets["map-view"] = {
    ...
    # @return void
    #
    _createWindBarbs: func() {
        me._windPath = me._content.createChild("path", "wind")
    ...
    updateTiles: func(model, forceSetTile = 0) {
        ...
        me._drawWindBarbs(model, track.wind_heading, track.wind_speed);
