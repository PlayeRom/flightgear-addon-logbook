...
You will find the CSV file in the directory `$FG_HOME/Export/Addons/org.flightgear.addons.logbook/logbook.csv`, where `$FG_HOME` on Windows is:
...
Plik CSV znajdziesz w katalogu `$FG_HOME/Export/Addons/org.flightgear.addons.logbook/logbook.csv`, gdzie `$FG_HOME` pod Windows to:
